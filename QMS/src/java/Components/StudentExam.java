    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<body> <div class=\"navbar\">\n"
                    ...
                    + "<form method='get' action='StudentExam' class='ui small form'>"
            ...
            for (Student s : list) {
                out.print("<tr class='center aligned'><td>" + s.getExamName2() + "</td><td>" + s.getExamDate() + "</td><td><a class='ui positive button' href='StartExam?examName=" + s.getExamName2() + "'>Start Exam</a></td></tr>");
